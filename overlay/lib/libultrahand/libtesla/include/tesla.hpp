    ...
    namespace elm {
        ...
        public:
            ...
            void inline invalidate() {
                ...
                if (parent == nullptr) {
                    if (cfg::FramebufferWidth > 448 && ult::useRightAlignment) {
                        this->layout(cfg::FramebufferWidth - 448, 0, 448, cfg::FramebufferHeight);
                    } else {
        ...
        public:
            ...
            void draw(gfx::Renderer *renderer) override {
                ...
                if (!ult::limitedMemory && !ult::refreshWallpaper.load(std::memory_order_acquire) &&
                    ...
                    if (tsl::cfg::FramebufferWidth > 448 && ult::useRightAlignment) {
                        renderer->drawRect(tsl::cfg::FramebufferWidth - 448, 0, 448, 720, a(defaultBackgroundColor));
                    } else {
                ...
                if (tsl::cfg::FramebufferWidth > 448 && ult::useRightAlignment) {
                    renderer->drawRect(tsl::cfg::FramebufferWidth - 448 + 15, tsl::cfg::FramebufferHeight - 73, 448 - 30, 1, a(bottomSeparatorColor));
                } else {
    ...
    namespace impl {
        ...
        static void backgroundHapticsPoller(void* /*args*/) {
            ...
            while (true) {
                ...
                if (!ult::useHapticFeedback || hidReinitInProgress.load(std::memory_order_acquire)) {
